...
class Genius_General_Menu_Walker extends Walker_Nav_Menu
{
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) 
	{
		...
		$item_output .= $args->link_before . apply_filters( 'the_title', $item->title, $item->ID ) . $image_src . $args->link_after;
		$item_output .= '</a>';
