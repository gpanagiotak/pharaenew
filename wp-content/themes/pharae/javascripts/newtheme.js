    ...
    $.fn.extend({
        customSelect: function(options) {
            ...
            return this.each(function() {
                ...
                $select.addClass("hasCustomSelect").on("update", function() {
...
(function($) {
    $.fn.lightGallery = function(options) {
        var defaults = {
            ...
            el = $(this),
            $children, index, lightGalleryOn = false,
...
(function() {
    ...
    $.fn.initPageSlider = function() {
        ...
        if($("#page-slider").length > 0){
            console.log('page-slider exists');
    ...
    $.fn.initPhotoGallery = function() {
        ...
        $button.on("click", function(event) {
            ...
            return $.ajax({
                url: genius_theme.ajax_url,
                type: "get",
                data: {
                    action: "genius_theme_photo_gallery",
                    id: $id
                }
            }).done(function(data) {
    ...
    $(document).ready(function() {
        ...
        $(".gallery-carousel-items").lightGallery({
            caption: true,
...
jQuery(document).ready(function($) {
    ...
    var check_in_ready = 0;
    var check_out_ready = 0;
